...
$hsnno=$t1['hsnno'];  
$hsnquery=mysqli_query($link,"select service from products where hsn='$hsnno' or sac='$hsnno' limit 1") or die(mysqli_error($link));
...
$temp['Version'] = '1.1'; 
 ...
 //(int)number_format((float)$invdate, 2, '.', '');
  ...
  $temp['SellerDtls']['Pin'] = (float)number_format((float)500029, 2, '.', '');
  //'500029';
     ...
     $temp['BuyerDtls']['Addr1'] = 'Survey No.133,4-51 8th Floor';
      $temp['BuyerDtls']['Addr2'] = 'Beside Botanical Gardens';
       $temp['BuyerDtls']['Loc'] = 'HYDERABAD';
        $temp['BuyerDtls']['Pin'] = (float)number_format((float)500032, 2, '.', '');
