...
<b>PAN No:-AAACO8174A   <br/>GST NO:-24AAACO8174A1ZR </b></pre></th>
...
<table style="width:100%;height:250px;" border=1 BORDERCOLOR=BLACK>
		  
		  <tr class="noBorder">
		      
            <td colspan="2" style="width:100%;">
                <b>Po No &nbsp;&nbsp;&nbsp; <?php echo $po_no; ?></b><br/>
		      <b>PO DATE&nbsp;&nbsp;&nbsp;<?php echo $po_date; ?></b><br/>
...
<th style="width:12%">Item Job Code</th>
...
<?php
  $y="select distinct(cgst) from add_gbill where service_no='$service_no' and id1='$bid' ";
...
$cont=mysqli_num_rows($sq);
 ...
 while($r=mysqli_fetch_array($sq)){
	 ...
	 $u="select  sum(tax_amnt) as tax_amnt,sum(gst_amnt) as gst from add_gbill where service_no='$service_no' and cgst='$sggst' and id1='$bid'";
...
while($t1=mysqli_fetch_array($t)){
	...
	echo $t1['sacno'];
		...
		<th style="width:12%;"><?php echo $t1['item_code']; ?></th>
...
<tr>
 ...
 <td colspan="4" align="right" style="font-size:14px;"><b>Basic Amounts - <?php echo $k;?> </b></td>
 ...
 <td  colspan="4" align="right"  style="font-size:14px;"><b>CGST <?php echo $sggst;?>%</b></td>
 ...
 <td colspan="4" align="right" style="font-size:14px;"><b>SGST <?php echo $sggst;?>%</b></td>
 <th style="font-size:16px; border-right-color: #000 !important;"> <?php echo number_format((float)$gst_amnt1/2,1,'.',''); ?></th>
 </tr>
 <?php if($cont==1){?>
 <tr>
 ...
 <td colspan="4" align="right" style="font-size:14px;"><b>Total Tax </b></td>
...
//$x++;
 ...
 <?php if($cont ==1){ echo '<tr></tr>'; }else{ ?>
  <tr>
 <td colspan="3" ></td><
 <td colspan="4"  style="font-size:14px; border-right-color: #000 !important;"><b>Taxable Amount -
...
echo implode('+', $s);
 ...
 <td colspan="4" align="right" style="font-size:14px; "><b>Total Amount After Tax </b></td>
 <th style="font-size:16px; border-right-color: #000 !important;"> <?php echo $tamt1; 
...
$mpdf->SetHTMLHeader('<img src="aposps.png" width="100%"/>');
$mpdf->SetHTMLFooter('<div style="text-align:center;font-size:12px;">BRANCH OFFICE:BUNGALOW NO. 11, GREENVILLA 1,JAIN NAGAR OPP GHUMA, Ahmedabad,Gujarat, 380058</div>             
...
<div style="font-size:12px;text-align:center;">Regd.Office : Farha Villa, D.No.8-1-22/1/J/1, 7 Tombs Road, Tolichowki, Hyderabad - 500 008. T.S.</div>
');

$mpdf->writeHTML($body);
$mpdf->Output('gdemo.pdf','F');
error_reporting(E_ALL);
ini_set('display_errors', 1);
	print "<script>";
	print "self.location='gdemo.pdf';";
	print "</script>";
