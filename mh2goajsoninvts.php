...
$t=mysqli_query($link,"select * from add_goabill where service_no='$service_no'") or die(mysqli_error($link));
...
$hsnno=$t1['hsnno'];  
$hsnquery=mysqli_query($link,"select service from goaproducts where hsn='$hsnno' or sac='$hsnno' limit 1") or die(mysqli_error($link));
...
$temp['Version'] = '1.1'; 
 ...
 //(int)number_format((float)$invdate, 2, '.', '');
  ...
  $temp['SellerDtls']['Em'] = 'ghousekhan@ospsindia.com';
   $temp['BuyerDtls']['Gstin'] = '30AADCB0274F3ZY';
    $temp['BuyerDtls']['LglNm'] = 'INDUS TOWERS LIMITED';
     $temp['BuyerDtls']['Addr1'] = 'Maharashtra Goa Logical Warehouse OFFICE Solramui Court F1 Gomes Pereira';
      $temp['BuyerDtls']['Addr2'] = 'Road, Panjim,Goa';
       $temp['BuyerDtls']['Loc'] = 'GOA Place of Supply:GOA 403001 GOA';
        $temp['BuyerDtls']['Pin'] = (float)number_format((float)411014, 2, '.', '');
         $temp['BuyerDtls']['Pos'] = '30';
          $temp['BuyerDtls']['Stcd'] = '30';
