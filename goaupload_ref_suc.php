	...
	if(in_array($_FILES["file"]["type"],$mimes)){
	 ...
	 //$res=mysql_query($ten_ins) or die(mysql_error());
			$q=$link->query($query);
						...
						$m="update goarefferences set  site_name ='".addslashes($site_name)."' ,district='$district',  state='$state',seeking_id='$seeking_id', po_num='$po_num',allocation_date='$allocation_date2',comp_date='$comp_date',sitetype='$sitetype'  where indus_id='$indus_id1' and sitetype='$sitetype1' and location='$location1' and req_ref='$req_ref1' ";
		...
		print "<script>";
			...
			print "self.location='goarefferno.php';";
			print "</script>";
		}
	}else { 
