...
.btn-info:hover {
  background-color: #31b0d5; /* New background color on hover */
  border-color: #269abc; /* New border color on hover */
...
th {
  ...
  background-image: linear-gradient(to bottom, #0074D9, #7FDBFF); /* Gradient from blue to light blue */
  /* Other styles */
}
        .btn-info {
    background-color: smokewhite; /* Set the default background color */
    color: purple; /* Set the default text color */
    border: none;
    border-radius: 4px;
    cursor: pointer;
...
.btn-info:hover {
    background-color: black; /* Set the black color on hover */
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="ebill_list.php">Edit Billing List</a>
                            </li>
...
<button class="btn btn-info" type="submit" name="rejected">
    Bulk  XL Download    <a href="bulk.php">   Here </a> 
</button>
...
<!--<td class="center">
    ...
    <?php 
        if($bill_status == "Active"){
            echo "<b style='color: blue;'>".$bill_status."</b>";
        } elseif($bill_status == "Approved") {
            echo "<b style='color: green;'>".$bill_status."</b>";
        } elseif($bill_status == "Released") {
            echo "<b style='color: purple;'>".$bill_status."</b>";
        } elseif($bill_status == "Pending") {
            echo "<b style='color: orange;'>".$bill_status."</b>";
        } elseif($bill_status == "Rejected") {
            echo "<b style='color: red;'>".$bill_status."</b>";
        } else {
            echo "<b>".$bill_status."</b>";
        }
    ?>
</td>
    ...
    <?php if ($bill_status != 'Approved') { ?>
        <a onClick="return confirm('Are you sure you want to delete this item?');" href="bill_delete.php?id=<?php echo $rs1['id']; ?>">
...
$start_from = ($page-1) * $results_per_page;
                                                   ...
                                                   // $q="select * from add_bill1  order by id desc";
													...
													$q = "SELECT * FROM ".$datatable."  WHERE bill_status IN ('Active','Pending','Rejected')  ORDER BY id desc LIMIT $start_from, ".$results_per_page;
