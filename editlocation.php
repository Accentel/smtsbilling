                               ...
                               <div class="box box-info">
                                ...
                                <div class="form-group">
									...
									<div class="form-group">
                                    	...
                                    	<div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Email 4 </label>

                                        <div class="col-sm-6">
                                            <input type="email" class="form-control" id="e4" name="e4" required placeholder="Enter Email" value="<?php echo $e4; ?>" /> 
