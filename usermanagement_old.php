            ...
            <div class="main-content">
              ...
              <div class="box-body">
				...
				<div class="form-group">			
                  ...
                  <div class="col-sm-3">
				  <input type="checkbox" name="menu[]" value="3" /> Billing<br/>
				...
				<div class="form-group">
				<div class="col-sm-3">
				  <input type="checkbox" name="menu[]" value="9" /> Billing<br/>
					  &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="menu[]" value="94" />Upload Bills<br/>
				...
				<div class="col-sm-3">
				  <input type="checkbox" name="menu[]" value="4" />Reports<br/>
				   &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="menu[]" value="41" />Bill Summary<br/>
				...
				<div class="col-sm-3">
				  ...
				  <input type="checkbox" name="menu[]" value="7" />Apporve Bills<br/>
				   <!-- &nbsp;&nbsp;&nbsp;<input type="checkbox" name="menu[]" value="71" />Maharashtra Bills<br/> -->
				  	 &nbsp;&nbsp;&nbsp;<input type="checkbox" name="menu[]" value="72" /> Bills<br/>	
				...
				<div class="col-sm-3">
				  <input type="checkbox" name="menu[]" value="100" />Upload Formats<br/>
					  &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="menu[]" value="101" />Upload Bill Formats<br/>
