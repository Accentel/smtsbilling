...
header("Content-disposition: attachment; filename=GOAInvoice_summary".date('d-m-Y').".xls");
...
<center><h2><u>GOA Summery</u></h2></center>
<div >
    <table class="left" border="1">
      ...
      <tr>
      <?php $sq=mysqli_query($link,"select * from add_goabill1 where `date` between '$from' and '$to'");
	     $i=1;
	  while($r=mysqli_fetch_array($sq))
	  {
		$rf=$r['req_ref'];
		$t=mysqli_query($link,"select * from goarefferences where req_ref='$rf'");
