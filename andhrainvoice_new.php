...
<table  width="500" >
<tr>
<td><b>PAN No:-AAACO8174A<br/>GST NO:-36AAACO8174A1ZM</b></td>
...
echo implode('+', $s);
 ...
 $aak="select distinct cgst  from add_apbill where service_no='$service_no' ";
 $apk=mysqli_query($link,$aak);
 while($ak1=mysqli_fetch_array($apk)){
     $igst=2*$ak1['cgst'];
     $igst1=$ak1['cgst'];
     
     $uj=mysqli_query($link,"select sum(cgstamount) as cgamount from add_apbill where service_no='$service_no' and cgst='$igst1' ");
