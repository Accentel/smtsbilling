...
<div class="row">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="select * from goa_bill1 where service_no like  '%$bsearch%' or date like  '%$bsearch%' ";
...
<!--<td class="center">
                                                        ...
                                                        <td class="hidden-480"><a href="edit_goabill1.php?id=<?php echo $rs1['id']; ?>">
														...
														<a onclick="window.open('goainvoice_new.php?id=<?php echo $rs1['id']; ?>&loc=<?php echo $rs1['location'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs" ><img src="images/printer.png"></a>
														 <?php }?>
														...
														<a onclick="window.open('tscheckedlist.php?id=<?php echo $rs1['id']; ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
														 <?php }?>
                                                          ...
                                                          <a href="qut_excel.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="xl.jpg" width="20" height="20"></a>
                                                         ...
                                                         <?php if( ($bill_status=='') ){?>
                                                          ...
                                                          <a onClick="return confirm('Are you sure you want to delete this item?');" href="goabill_delete.php?id=<?php echo $rs1['id']; ?>"><img src="images/Icon_Delete.png"></a>
...
echo "<li><a href='goabill_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='goabill_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
