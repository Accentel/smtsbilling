...
if (isset($_POST['submit'])) {
 ...
 $res = mysqli_query($link, "insert into employee(emp_name,emp_email,username,password,user) values('$emp_name','$emp_email','$username','$password','$user')") or die("could not connected" . mysqli_error($link));
