            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <?php $id=$_GET['id'];
						$sq=mysqli_query($link,"select * from goarefferences where id='$id'");
...
<div class="row">
 ...
 <form name="frm" method="post" action="goareffer_suc.php">
 <input type="hidden" name="id" value="<?php echo $id?>">
                                      ...
                                      <td align="right">Site Type</td><td align="left"><input type="text"  class="form-control" name="site_type"  value="<?php echo $stype;?>"></td>
                                        ...
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="goarefferno.php"><button class="btn btn-danger" type="button" name="button" id="Close">
