                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title"> Karnataka Upload Items</h3>
								</div>
                               
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="kubill_suc.php" enctype="multipart/form-data" autocomplete="off">
									...
									<!--<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
											...
											<?php $sq=mysqli_query($link,"select distinct category from kproducts");
