...
$sql = "SELECT * FROM add_bill1 WHERE bill_status IN ('Active', 'Pending') ORDER BY service_no DESC";
...
header('Content-Disposition: attachment;filename="To be Approved.xlsx"');
