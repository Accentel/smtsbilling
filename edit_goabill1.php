                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="bill_list.php"> Edit GOA Billing</a>
                            </li>
                            <li>
                                <a href="">Edit GOA Billing</a>
                            </li>
...
<div class="row">
 ...
 <form name="frm" method="post" action="agoabill_status.php">
 ...
 <input type="hidden" name="location" value="<?php echo $r['location'];?>">
  <input type="hidden" name="email" value="<?php echo $email;?>">
                                        ...
                                        <tr><td align="right">Allocation Date</td><td align="left"><input type="date" value="<?php echo $r['allcoation_date'];?>"  class="form-control" name="allcoation_date" id="allcoation_date"></td>
										...
										<td><select name="status" id="status" class="form-control">
										 ...
										 <td align="right">Pcw No</td><td><input type="text" value="<?php echo $r['pcw'];?>" name="pcw"  class="form-control"></td>
										</tr>
                                        <tr>
                                         <td align="right">Ack No</td><td><input type="text" value="<?php echo $r['ackno'];?>" name="ackno"  class="form-control"></td>
