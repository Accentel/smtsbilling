            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <?php $id=$_GET['id'];
						$sq=mysqli_query($link,"select * from add_kbill1 where id='$id'");
...
<div class="row">
 ...
 <input type="hidden" name="id" value="<?php echo $id?>">
                                        ...
                                        <td align="right">Payment Documen Date</td><td><input type="date" value="<?php echo $r['payment_doc_date'];?>" name="payment_doc_date"  class="form-control"></td>
                                         ...
                                         <tr>
                                        <td align="right">PCW NO</td><td><input type="text" name="pcw" id="pcw" value="<?php echo $r['pcw'];?>"  class="form-control"></td>
...
<button type="button" class='btn btn-danger delete'>-</button>
											...
											<?php   //$id=count($_POST['id']);
											 $aa="select * from add_kbill where id1='$id'";
 ...
 from add_bill b,products a where b.service_no='$service_no' and b.item_code=a.item_code";*/
												...
												while($rs1=mysqli_fetch_array($sq)){
													...
													?>
                                                    <tr>
													<td><a href="dbfiles/delete_kt.php?id=<?php echo $rs1['id'];  ?>&id1=<?php echo $rs1['id1']; ?>"><img src="images/Icon_Delete.png"/></a></td>
						...
						<input type="text" name="cgstamt[]" value="<?php echo $rs1['cgstamount']; ?>" style="width:60px;" readonly class="txt51" id="cgstamt<?php echo $i?>" />   
									...
									?>
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="kbill_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">
