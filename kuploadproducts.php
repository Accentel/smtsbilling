                        ...
                        <div class="row">
                            <div class="col-xs-6">
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="kuploadproducts_suc.php" enctype="multipart/form-data" autocomplete="off">
...
<div class="row">
                          ...
                          <a href="addkproducts.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>
                                    <div class="col-xs-12">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div>
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="select * from kproducts where item_code like  '%$bsearch%' or item_desc like  '%$bsearch%' ";
...
<td class="center">
                                                        ...
                                                        <?php if($name=='admin'){?>
                                                         <td>
														 <a href="edit_kprd.php?id=<?php echo $rs1['id'];?>"><img src="images/edit.gif"></a>
														 <a href="delete_kprd.php?id=<?php echo $rs1['id'];?>"><img src="images/Icon_Delete.png"></a>
														 </td>
                                                       <?php }?>
...
echo "<li><a href='kuploadproducts.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='kuploadproducts.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
