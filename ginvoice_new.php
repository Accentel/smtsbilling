...
?>
<header>
      <img src="aposps.png" style="width:100%;height:120px;"/>
    </header>
...
$cont=mysqli_num_rows($sq);
 ...
 while($r=mysqli_fetch_array($sq)){
	 ...
	 $u="select  sum(tax_amnt) as tax_amnt,sum(cgstamount) as gst from add_gbill where service_no='$service_no' and cgst='$sggst' and id1='$bid'";
...
<footer>
 ...
 <span class="pagenum"></span>-->
    <hr/>
  <div style="font-size:18px;">Branch Office : BUNGALOW NO. 11,GREENVILLA 1,JAIN NAGAR OPP GHUMA,Ahmedabad,Gujarat,380058.</div>             
