...
<div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                   <a href="addgoaproducts.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>    
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div>
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="select * from goaproducts where item_code like  '%$bsearch%' or item_desc like  '%$bsearch%' ";
...
echo "<li><a href='goauploadproducts.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='goauploadproducts.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
