    ...
    $("#register-form").validate({
        ...
        rules: {
            ...
            service_no: {
					   ...
					   remote: "goaemailcheck1.php?data=service_no"
					},
			...
			wcc_num:{
					 ...
					 remote: "goaemailcheck1.php?data=wcc_num"
				  ...
				  wcc_rec_num:{
					 ...
					 remote: "goaemailcheck1.php?data=wcc_rec_num"
...
xmlhttp.open("GET","get-goadata1.php?q="+str,true);
xmlhttp.send();
}
</script>
<script>
...
<div class="row">
 ...
 <form  method="post"  action="goabill_suc.php">
...
<?php 
$sql="select distinct req_ref from goarefferences ";  // Query to collect records
...
echo "</datalist>";?></datalist>
										...
										$rt=mysqli_query($link,"select * from goabill where id='$uid'") or die(mysqli_error($link));
...
<button type="button" class='btn btn-danger delete'>-</button>
										...
										$y1="select distinct a.line,a.itemdesc,a.uom,a.price,a.qty,a.amount,b.item_code,b.hsn,b.sac,b.cgst,b.sgst,b.igst from  goabill1 a left join goaproducts b  on a.itemdesc=b.item_desc  where  a.id1='$uib' order by a.uid asc";
