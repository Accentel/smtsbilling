...
$sql = "SELECT * FROM add_bill1 WHERE bill_status IN ('Released', 'Active', 'Rejected', 'Pending', 'Approved') ORDER BY service_no DESC";
...
header('Content-Disposition: attachment;filename="All Bills.xlsx"');
